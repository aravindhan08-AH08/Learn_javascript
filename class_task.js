...
let expensiveFurniture = Products.filter(
  (product) => product.category === "Furniture" && product.price > 300,
);
...
let productNamesAndPrices = Products.map(
...
let upperCaseTags = Products.map((product) =>
